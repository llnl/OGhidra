...
class TestBridge(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.bridge.llm_client.generate_with_phase.return_value = "Test response"
    ...
    def test_run_execution_phase_safety_counter(self):
        ...
        self.bridge.llm_client.generate_with_phase.return_value = "FINAL RESPONSE: We should rename the function."
    ...
    def test_nested_calls_termination(self):
        ...
        self.bridge.llm_client.generate_with_phase.return_value = "FINAL RESPONSE: Some analysis here."
    ...
    def test_normalize_command_name_integration(self):
        ...
        self.assertEqual(test_bridge._normalize_command_name("nonExistentCommand"), "nonExistentCommand")
