...
class ToolCapabilityTester:
    ...
    def _initialize_client(self) -> None:
        ...
        try:
            ...
            self.available_tools = [
                name for name in dir(self.client) if not name.startswith("_") and callable(getattr(self.client, name))
            ]
    ...
    def gather_function_data(self) -> None:
        ...
        try:
            ...
            if methods:
                ...
                print(
                    f"Found {len(self.available_functions)} functions and {len(self.available_addresses)} addresses for testing"
                )
    ...
    def run_all_tests(self, specific_tools: Optional[List[str]] = None) -> Dict[str, Dict[str, Any]]:
        ...
        basic_tools = [
            ...
            "list_functions",
            "list_strings",
            "instances_list",  # Added instances_list
        ]
