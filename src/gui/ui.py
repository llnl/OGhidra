...
class OGhidraUI:
    ...
    def __init__(self, bridge: Bridge, config: BridgeConfig):
        ...
        # Initialize application theme colors for raw tk widgets
        self._theme_colors = ThemeColors(self.style)
    ...
    def _setup_sidebar_panel(self, parent):
        ...
        self.sub_agent_tree = SubAgentTreePanel(parent, self.sub_agent_registry, self._theme_colors)
    ...
    def _load_session_streaming(self, session_data: Dict[str, Any], session_info: Dict[str, Any]):
        ...
        try:
            import threading
            from tkinter import Button, Label, Toplevel, messagebox, ttk
            ...
            # Title
            title_label = Label(content_frame, text=f"Loading Large Session", font=("Arial", 14, "bold"))
