...
class EnhancedSessionManager:
    ...
    def __init__(self, sessions_dir: str = "analysis_sessions"):
        ...
        self.load_stats = {"last_load_time": 0, "last_functions_loaded": 0, "streaming_enabled": True}
    ...
    def export_session(self, session_identifier: str, export_path: str, include_vectors: bool = True) -> bool:
        """
