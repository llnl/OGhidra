                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "address": {
                                "type": "string",
                                "description": "Function address (numerical only, like '140003e50')",
                            }
                        },
                        "required": ["address"],
                    },
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "address": {
                                "type": "string",
                                "description": "Function address (optional)",
                            }
                        },
                    },
                },
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "address": {
                                "type": "string",
                                "description": "Target address in hexadecimal or numeric format",
                            },
                            "offset": {
                                "type": "integer",
                                "description": "Pagination offset",
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "address": {
                                "type": "string",
                                "description": "Source address in hexadecimal or numeric format",
                            },
                            "offset": {
                                "type": "integer",
                                "description": "Pagination offset",
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "name": {
                                "type": "string",
                                "description": "Function name (e.g., 'FUN_401000')",
                            },
                            "offset": {
                                "type": "integer",
                                "description": "Pagination offset",
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            "address": {
                                "type": "string",
                                "description": "Starting address in hex format (e.g., '401000')",
                            },
                            "length": {
                                "type": "integer",
                                "description": "Number of bytes to read (1-4096, default: 16)",
                            },
                            "format": {
                                "type": "string",
...
class SessionHistoryConfig(BaseModel):
    ...
    storage_path: str = Field(
        default="data/ollama_ghidra_session_history.jsonl",
        description="Path to session history file",
    )
    max_sessions: int = Field(
        ge=1,
        le=100000,
        default=1000,
        description="Maximum number of sessions to store (1-100000)",
    )
